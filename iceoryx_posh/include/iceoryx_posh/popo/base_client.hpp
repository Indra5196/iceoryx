...
///
template <typename port_t = iox::ClientPortUserType>
class BaseClient
{
  public:
    ...
    cxx::expected<const mepoo::ChunkHeader*, ChunkReceiveResult> takeResponses() noexcept;
  ...
  protected:
    ...
    void enableEvent(iox::popo::TriggerHandle&& triggerHandle, const ClientEvent clientState) noexcept;
