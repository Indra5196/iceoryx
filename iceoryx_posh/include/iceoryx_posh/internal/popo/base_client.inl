...
template <typename port_t>
inline cxx::expected<const mepoo::ChunkHeader*, ChunkReceiveResult> BaseClient<port_t>::takeResponses() noexcept
{
    return m_port.getResponse();
}

template <typename port_t>
inline bool BaseClient<port_t>::hasResponse() const noexcept
{
