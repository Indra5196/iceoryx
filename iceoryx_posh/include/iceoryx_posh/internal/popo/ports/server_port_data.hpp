...
struct ServerPortData : public BasePortData
{
    ...
    using ChunkQueueData_t = ChunkQueueData<ClientChunkQueueConfig, ThreadSafePolicy>;

    static constexpr SubscriberTooSlowPolicy SERVER_SUBSCRIBER_POLICY = SubscriberTooSlowPolicy::DISCARD_OLDEST_DATA;
    static constexpr QueueFullPolicy SERVER_PUBLISHER_POLICY = QueueFullPolicy::BLOCK_PUBLISHER;
