...
#define ICEORYX_ERRORS(error) \
    ...
    error(POSH__RUNTIME_CLIENT_PORT_CREATION_UNDEFINED_BEHAVIOR) \
    error(POSH__RUNTIME_SERVER_PORT_CREATION_UNDEFINED_BEHAVIOR) \
    error(POSH__RUNTIME_ROUDI_PUBLISHER_LIST_FULL) \
    error(POSH__RUNTIME_ROUDI_SUBSCRIBER_LIST_FULL) \
    error(POSH__RUNTIME_ROUDI_CLIENT_LIST_FULL) \
    error(POSH__RUNTIME_ROUDI_SERVER_LIST_FULL) \
    ...
    error(POPO__BASE_CLIENT_OVERRIDING_WITH_EVENT_SINCE_HAS_DATA_OR_DATA_RECEIVED_ALREADY_ATTACHED) \
    error(POPO__BASE_CLIENT_OVERRIDING_WITH_STATE_SINCE_HAS_DATA_OR_DATA_RECEIVED_ALREADY_ATTACHED) \
    error(POPO__BASE_SERVER_OVERRIDING_WITH_EVENT_SINCE_HAS_DATA_OR_DATA_RECEIVED_ALREADY_ATTACHED) \
    error(POPO__BASE_SERVER_OVERRIDING_WITH_STATE_SINCE_HAS_DATA_OR_DATA_RECEIVED_ALREADY_ATTACHED) \
